<template>
  <q-dialog v-model="modalObjetivo">
    <q-card class="full-width">
      ...
      <q-card-section>
        <q-form ref="formulario">
          ...
          <div class="q-my-xs">
            <label>Ingrese el peso del KPI </label>
          </div>
          ...
          <div class="row justify-between">
            <q-input
              class="q-pr-xs"
              style="max-width: 20rem; min-width: 48%"
              dense
              filled
              label="Objetivo"
              type="number"
              color="primary"
              v-model="objKpi.objetivo"
              :rules="validarDigitos"
            >
              <template v-slot:prepend> </template>
            </q-input>
            <q-input
              ...
              type="number"
              color="primary"
              v-model="objKpi.objetivoCumplimiento"
              :rules="validarDigitos"
            >
              <template v-slot:prepend> </template>
            </q-input>
...
export default {
  setup() {
    ...
    const { mesSeleccionado, anioSeleccionado, quincenaSeleccionada } =
